...
namespace RB::PlayerStateComponents
{
	...
	void StandUpOnRelease::OnFixedUpdate()
	{
		...
		bool down = inputController->IsHeld(player->GetPLAYER_TYPE(), Input::PlayerInput::MOVE_DOWN);
		bool downLeft = inputController->IsHeld(player->GetPLAYER_TYPE(), Input::PlayerInput::MOVE_DOWN_LEFT);
		bool downRight = inputController->IsHeld(player->GetPLAYER_TYPE(), Input::PlayerInput::MOVE_DOWN_RIGHT);
