...
namespace RB::Sprites
{
	...
	void SpriteDataController::Init()
	{
		...
		_vecEnumStrings.push_back(new SpriteTypeString(SpriteType::fighter_0_jab, "fighter_0_jab"));
		_vecEnumStrings.push_back(new SpriteTypeString(SpriteType::fighter_0_wince, "fighter_0_wince"));
	}
