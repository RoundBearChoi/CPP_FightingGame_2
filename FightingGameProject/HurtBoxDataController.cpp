...
namespace RB::HBox
{
	...
	Loaded_HB_Data* HurtBoxDataController::GetData(RB::Sprites::SpriteType spriteEnum)
	{
		return _hbLoader.GetData(spriteEnum);
	}

	const std::string& HurtBoxDataController::GetPath(RB::Sprites::SpriteType spriteEnum) const
	{
