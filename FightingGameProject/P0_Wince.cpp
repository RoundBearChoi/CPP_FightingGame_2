...
namespace RB::PlayerStates
{
	void P0_Wince::OnEnter()
	{
		...
		AddStateComponent(new RB::PlayerStateComponents::MoveHorizontalOnFixedUpdateCount(0, false, 4));
		AddStateComponent(new RB::PlayerStateComponents::MoveHorizontalOnFixedUpdateCount(2, true, 4));
